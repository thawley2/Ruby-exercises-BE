RSpec.describe 'max_by' do
  ...
  it 'array with the most items' do
    ...
    biggest_array = arrays.max_by {|array|
      array.size
    }
  ...
  it 'array with fewest items' do
    ...
    smallest_array = arrays.max_by {|array| -array.size}
  ...
  it 'most programmers' do
    ...
    most_programmers = programmers.max_by {|most|
      most}
  ...
  it 'fewest programmers' do
   ...
   fewest_programmers = programmers.max_by {|key, value|  -value.length 
